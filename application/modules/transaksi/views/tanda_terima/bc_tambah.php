...
<style>
    /* Preview image responsive mengikuti lebar input */
    .preview-wrapper {
        width: 100%;
    ...
    .preview-wrapper .preview-image {
        ...
        width: 100%;
        height: auto;
        max-height: 320px; /* batas wajar agar tidak terlalu tinggi */
	...
	<div class="col">
		...
		<div class="card">
			<div class="card-body">
                ...
                <form id="formTambah" enctype="multipart/form-data" class="row g-3" action="<?= base_url($mod.'/'.$func.'/tambah'); ?>" method="POST">
                    ...
                    <div class="row border-top mt-2 mb-1 p-1 m-1">
                        <h5 class="text-black mt-2 mb-1 text-black"><strong>Foto Bukti Tanda Terima</strong></h5>
                        <div class="col-12 col-md-4">
                            <label class="form-label text-black"><strong>Foto 1<span style="color:red">*</span></strong></label>
                            <input class="form-control file-input-item" type="file" name="images[]" accept="image/jpeg,image/jpg,image/png">
                            <div class="preview-wrapper mt-2">
                                <img class="img-fluid preview-image d-none" alt="Preview Foto 1" />
                            </div>
                        </div>

                        <div class="col-12 col-md-4">
                            <label class="form-label text-black"><strong>Foto 2</strong></label>
                            <input class="form-control file-input-item" type="file" name="images[]" accept="image/jpeg,image/jpg,image/png">
                            <div class="preview-wrapper mt-2">
                                <img class="img-fluid preview-image d-none" alt="Preview Foto 2" />
                            </div>
                        </div>

                        <div class="col-12 col-md-4">
                            <label class="form-label text-black"><strong>Foto 3</strong></label>
                            <input class="form-control file-input-item" type="file" name="images[]" accept="image/jpeg,image/jpg,image/png">
                            <div class="preview-wrapper mt-2">
                                <img class="img-fluid preview-image d-none" alt="Preview Foto 3" />
                            </div>
                        </div>
                    </div>
...
$(document).ready(function() {
    ...
    $('.select2-single').select2();
     ...
     // Handler preview foto untuk setiap input file
    $(document).on('change', '.file-input-item', function(e) {
        const input = e.target;
        const wrapper = $(input).closest('.col-12, .col-md-4');
        const img = wrapper.find('.preview-image').get(0);
        if (!img) return;
        ...
        if(count_kd_double == 0 ){
            ...
            if(jns_kode == 'OUT'){
                $('input[name="qty[]"]').keyup(function (event) {
                    ...
                    // else{
                        // countTempQty(kd_brg,qty,'34',this,input_qty);
                    // }
                    // count_qty();
                });
            }
