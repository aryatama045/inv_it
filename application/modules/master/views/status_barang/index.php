            ...
            <div class="card-body shadow">
                <div class="row  g-0">
                    <div class="col-3 text-center">
                        ...
                        <div class="cta-1 text-black font-weight-bold">235</div>
                    </div>
                    <div class="col-3 text-center">
                        <div class="text-muted mb-1">KATEGORI</div>
                        <div class="cta-1 text-black font-weight-bold">421</div>
                    </div>
                    <div class="col-3 text-center">
                        <div class="text-muted mb-1">MERK</div>
                        <div class="cta-1 text-black font-weight-bold">752</div>
                    </div>
                    <div class="col-3 text-center">
                        <div class="text-muted mb-1">TYPE</div>
                        <div class="cta-1 text-black font-weight-bold">53</div>
                    </div>
                </div>
            </div>
								...
								<div class="col-3 text-center">
									<div class="form-group ">
										<select class="form-control" name="jenis" id="jenis" >
											...
											<option value="NORMATIF">Cuti Normatif</option>
