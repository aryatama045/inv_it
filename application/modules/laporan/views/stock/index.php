				...
				<div class="col-12 col-md-5 d-flex align-items-start justify-content-end">
                    ...
                    <div class="ms-1">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <button class="dropdown-item" type="button"><i class="fas fa-file-excel"></i> Excel</button>
                            <button class="dropdown-item" type="button"><i class="fas fa-print"></i> Print</button>
                        </div>
                    </div>
                    <!-- Dropdown Button End -->

					<!-- Add New Button Start -->
					<a hidden href="<?= base_url($mod.'/'.$func.'/tambah') ?>" class="btn btn-outline-primary btn-icon btn-icon-start w-100 w-md-auto m-1">
