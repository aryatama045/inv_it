	...
	<div class="col">
		...
		<div class="card">
			<div class="card-body">
                ...
                <form class="row g-3" action="<?= base_url($mod.'/'.$func.'/edit/'.$param['status_barang']); ?>" method="POST">

                    <div class="col-12 col-md-6">
                        <label class="form-label text-black-50"><strong>Status<span style="color:red">*</span></strong></label>
                        <input type="text" class="form-control" required name="status_barang" value="<?= $param['status_barang'] ?>" readonly />
                    </div>
